...
export default {
    ...
    shippingListUpdateSuccess: 'Shipping list updated success',
    courier: 'Courier',
    ...
    listShippingList: 'List shipping list',
    ...
    generateInvoicesDescription: '¿Are you sure you want to generate invoices for the selected orders?',
    invoicesGenerationStarted: 'Invoice generation started. We will notify you when it is ready.',
    ...
    pdfGenerationStarted: 'PDF generation started. We will notify you when it is ready.',
    ...
    errorMarkingAllAsRead: 'Error marking notifications',
    notificationDeleted: 'Notification deleted',
    errorDeletingNotification: 'Error deleting notification',
    view: 'View',
    performanceReport: 'Performance Report',
    deliveryReport: 'Delivery Report',
    averageDeliveryTime: 'Delivery time',
    efficiency: 'Efficiency',
    assignedRoutes: 'Assigned routes',
    performanceByVehicleType: 'Performance by vehicle type',
    vehicleType: 'Vehicle type',
    notAssigned: 'Not assigned',
    total: 'Total',
    noData: 'No data available',
    pdfNotAvailable: 'PDF generation not available for this report',
    ...
    selectShippingList: 'Select a shipping list',
    optimizationStrategy: 'Optimization strategy',
    selectStrategy: 'Select a strategy',
    haversine: 'Haversine',
    googleMaps: 'Google Maps',
    googleMapsApiKeyRequired: 'A Google Maps API key configured in your profile is required',
    generatePickupRoute: 'Generate pickup route',
    generateDeliveryRoute: 'Generate delivery route',
    selectAtLeastOneRouteType: 'You must select at least one route type',
    routesGeneratedSuccessfully: 'Routes generated successfully',
    strategy: 'Strategy',
    pointsCount: 'Points in route',
    listOptimizedRoute: 'List optimized routes',
    viewOptimizedRoute: 'View optimized routes',
    viewRoute: 'View route',
    routeDetails: 'Route details',
    routePoints: 'Route points',
    deleteRoute: 'Delete route',
    deleteRouteDescription: 'Are you sure you want to delete the route -name?',
    routeDeleted: 'Route deleted successfully',
    errorDeletingRoute: 'Error deleting route',
    noPickupPoints: 'No pickup points',
    noDeliveryPoints: 'No delivery points',
    errorGeneratingRoute: 'Error generating route',
    errorGeneratingPickupRoute: 'Error generating pickup route',
    errorGeneratingDeliveryRoute: 'Error generating delivery route',
    routeGenerated: 'Route generated successfully',
    requiredFieldsMissing: 'Required fields are missing',
    bothRoutesAlreadyExist: 'This shipping list already has both routes (pickup and delivery) generated',
    pickupRouteAlreadyExists: 'Pickup route already exists',
    deliveryRouteAlreadyExists: 'Delivery route already exists',
}