...
export default {
    ...
    close: 'Cerrar',
    recoveryPasswordProccessInit: 'Se ha enviado un correo electrónico con un token de verificación para poder continuar con el proceso',
    ...
    generateInvoicesDescription: '¿Estas seguro de querer generar facturas para las ordenes seleccionadas?',
    invoicesGenerationStarted: 'Generación de facturas iniciada. Te notificaremos cuando esté lista.',
    ...
    pdfGenerationStarted: 'Generación de PDF iniciada. Te notificaremos cuando esté listo.',
    ...
    deleteNotificationMessage: '¿Deseas eliminar esta notificación?',
    ...
    errorMarkingAllAsRead: 'Error al marcar notificaciones',
    ...
    deliveryReport: 'Reporte de Domicilio',
    averageDeliveryTime: 'Tiempo de entrega',
    efficiency: 'Eficiencia',
    assignedRoutes: 'Rutas asignadas',
    performanceByVehicleType: 'Rendimiento por tipo de vehículo',
    vehicleType: 'Tipo de vehículo',
    notAssigned: 'Sin asignar',
    total: 'Total',
    noData: 'No hay datos disponibles',
    pdfNotAvailable: 'Generación de PDF no disponible para este reporte',
    ...
    pickup: 'Recogidas',
    deliveryRoute: 'Entregas',
    both: 'Ambas',
    notGenerated: 'No generada',
    totalDistance: 'Distancia total',
    totalDuration: 'Duración total',
    generateRoute: 'Generar ruta',
    selectShippingList: 'Selecciona una relación de envíos',
    optimizationStrategy: 'Estrategia de optimización',
    selectStrategy: 'Selecciona una estrategia',
    haversine: 'Haversine',
    googleMaps: 'Google Maps',
    googleMapsApiKeyRequired: 'Se requiere una API key de Google Maps configurada en tu perfil',
    generatePickupRoute: 'Generar ruta de recogidas',
    generateDeliveryRoute: 'Generar ruta de entregas',
    selectAtLeastOneRouteType: 'Debes seleccionar al menos un tipo de ruta',
    routesGeneratedSuccessfully: 'Rutas generadas exitosamente',
    strategy: 'Estrategia',
    pointsCount: 'Puntos en ruta',
    listOptimizedRoute: 'Listar rutas optimizadas',
    viewOptimizedRoute: 'Ver rutas optimizadas',
    viewRoute: 'Ver ruta',
    routeDetails: 'Detalles de la ruta',
    routePoints: 'Puntos de la ruta',
    deleteRoute: 'Eliminar ruta',
    deleteRouteDescription: '¿Estás seguro de que deseas eliminar la ruta -name?',
    routeDeleted: 'Ruta eliminada exitosamente',
    errorDeletingRoute: 'Error al eliminar la ruta',
    noPickupPoints: 'No hay puntos de recogida',
    noDeliveryPoints: 'No hay puntos de entrega',
    errorGeneratingRoute: 'Error al generar la ruta',
    errorGeneratingPickupRoute: 'Error al generar la ruta de recogida',
    errorGeneratingDeliveryRoute: 'Error al generar la ruta de entrega',
    routeGenerated: 'Ruta generada exitosamente',
    requiredFieldsMissing: 'Faltan campos requeridos',
    bothRoutesAlreadyExist: 'Este shipping list ya tiene ambas rutas (recogida y entrega) generadas',
    pickupRouteAlreadyExists: 'La ruta de recogida ya existe',
    deliveryRouteAlreadyExists: 'La ruta de entrega ya existe',
}